...
import { Delete, DeleteIcon, Edit, FileDown, Plus, Search, Trash } from "lucide-react";
            ...
            <table className="border-separate border-spacing-y-4 ">
              <thead>
                <tr>
                  ...
                  <th className="text-start pr-4">Nama Materi</th>
                  <th className="text-start pr-4">Deskripsi</th>
                  <th className="text-start pr-4">File Materi</th>
              ...
              <tbody>
                {Array.from({ length: 5 }, (_, i) => (
                  <tr key={i} className="bg-[#F7F6FE]">
                    ...
                    <td className="py-3">TWK / Bahasa Indonesia</td>
                    <td className="py-3">Tes wawasan kebangsaan</td>
                    <td className="py-3">
                        <div className="flex items-center gap-3 cursor-pointer hover:text-green-600 w-fit box-border">
                            <FileDown size={18} />
                            <p>Lihat disini</p>
                        </div>
                    </td>
